const modules = [
  ...
  ["01", "Scalars, Coordinates, and Friendship Intensity", "modules/01-number-systems.md", "Decide what one coordinate can express in scores and profiles."],
  ...
  ["03", "Linear Maps and Changing Perspective", "modules/03-linear-maps-and-change.md", "Treat advice and perspective shifts as transformations."],
  ...
  ["05", "Duality, Measurement, and Dating Standards", "modules/05-duality-and-measurement.md", "Understand standards, scores, and constraints as covectors."],
  ["06", "Tensors and Dinner Table Relations", "modules/06-tensors-typed-relations.md", "Represent multi-slot dinner and social relations."],
  ["07", "Covariance, Contravariance, and Budget Units", "modules/07-covariance-contravariance.md", "Track how dinner budgets and measurements transform under unit changes."],
  ["08", "Hermitian Structure and Playlist Phase", "modules/08-hermitian-structure.md", "Preserve magnitude and phase in complex-valued playlist similarity."],
  ["09", "Spectral Theory and Friendship Moods", "modules/09-spectral-theory.md", "Find stable social modes and directions that survive repeated updates."],
  ["10", "Graphs, Incidence, and Party Tension", "modules/10-graphs-incidence-laplacians.md", "Measure disagreement and smoothing across friendship edges."],
  ["11", "Algebraic Graph Theory and Detective Boards", "modules/11-algebraic-graph-theory.md", "Use spectra and automorphisms to compare board structures."],
  ["12", "Hypergraphs, Simplicial Complexes, and Group Commitments", "modules/12-hypergraphs-simplicial-complexes.md", "Represent group-chat plans beyond pairwise edges."],
  ["13", "Groups, Symmetry, and Party-Game Moves", "modules/13-groups-and-symmetry.md", "Identify legal moves and what repeated moves preserve."],
  ["14", "Group Actions and Seating Chart Relabeling", "modules/14-group-actions-on-graphs.md", "Make abstract symmetry act on seating charts and graph data."],
  ["15", "Representations, Equivariance, and Dance Moves", "modules/15-representations-and-equivariance.md", "Turn symmetry into matrices that move with the dance."],
  ["16", "Invariant Operators and Reviewer Averaging", "modules/16-invariant-operators-and-reynolds.md", "Construct invariant judgments by averaging over relabelings."],
  ["17", "Category Theory I: Group Project Workflows", "modules/17-category-theory-i.md", "Treat project stages as objects and structure-preserving arrows."],
  ["18", "Universal Properties and Lunch Orders", "modules/18-universal-properties.md", "Define objects by the role they play in every mapping situation."],
  ["19", "Functors, Natural Transformations, and App Translations", "modules/19-functors-natural-transformations.md", "Translate notes between apps while preserving structure coherently."],
  ["20", "Categorical Databases and Club Roster Schemas", "modules/20-categorical-databases.md", "Treat typed club rosters as categories and instances."],
  ["21", "Operads and Dinner-Plan Composition", "modules/21-operads-compositional-systems.md", "Compose typed multi-input dinner-planning operations."],
  ["22", "Topology, Neighborhoods, and Friendship Thresholds", "modules/22-topology-neighborhoods-continuity.md", "Study social structure that survives changes of threshold."],
  ["23", "Persistent Homology and Friendship Circles", "modules/23-persistent-homology.md", "Track friendship clusters that survive across thresholds and scale."],
  ["24", "Sheaves and Local Dinner Reports", "modules/24-sheaves-local-global.md", "Glue local dinner reports into coherent global plans."],
  ["25", "Message Passing and Dinner Rumors", "modules/25-message-passing-belief-propagation.md", "Update dinner-plan probabilities through local graph messages."],
  ["26", "Probabilistic Graphical Models and Restaurant Recommendations", "modules/26-probabilistic-graphical-models.md", "Model hidden causes behind correlated restaurant recommendations."],
  ["27", "Energy, Constraints, and Dinner Planning", "modules/27-energy-constraints-optimization.md", "Choose the best feasible dinner plan under hard constraints."],
